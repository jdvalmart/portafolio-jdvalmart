      ...
      >
        {status === "success" ? (
          <div className="max-w-lg mx-auto text-center py-10">
            <div className="text-5xl mb-4">{lang === "es" ? "📬" : "📬"}</div>
          ...
          >
            ...
            <div>
              ...
              />
              {errors.name && (
                <p className="text-red-500 text-sm mt-1">{getValidationMessage("name")}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.email && (
                <p className="text-red-500 text-sm mt-1">{getValidationMessage("email")}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.subject && (
                <p className="text-red-500 text-sm mt-1">{getValidationMessage("subject")}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.message && (
                <p className="text-red-500 text-sm mt-1">{getValidationMessage("message")}</p>
              )}
            </div>
